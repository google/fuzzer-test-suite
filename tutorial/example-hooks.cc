...
void __sanitizer_cov_trace_cmp8(uint64_t Arg1, uint64_t Arg2) {
  fprintf(f, "%p: cmp8(%lu, %lu)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_const_cmp8(uint64_t Arg1, uint64_t Arg2) {
  fprintf(f, "%p: ccmp8(%lu, %lu)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_cmp4(uint32_t Arg1, uint32_t Arg2) {
  fprintf(f, "%p: cmp4(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_const_cmp4(uint32_t Arg1, uint32_t Arg2) {
  fprintf(f, "%p: ccmp4(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_cmp2(uint16_t Arg1, uint16_t Arg2) {
  fprintf(f, "%p: cmp2(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_const_cmp2(uint16_t Arg1, uint16_t Arg2) {
  fprintf(f, "%p: ccmp2(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_cmp1(uint8_t Arg1, uint8_t Arg2) {
  fprintf(f, "%p: cmp1(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_const_cmp1(uint8_t Arg1, uint8_t Arg2) {
  fprintf(f, "%p: ccmp1(%u, %u)\n", __builtin_return_address(0), Arg1, Arg2);
}

void __sanitizer_cov_trace_switch(uint64_t Val, uint64_t *Cases) {
  // TODO: Print which case is taken.
  fprintf(f, "%p: switch(%lu)\n", __builtin_return_address(0), Val);
}

void __sanitizer_cov_trace_div4(uint32_t Val) {
  fprintf(f, "%p: div4(X, %u)\n", __builtin_return_address(0), Val);
}

void __sanitizer_cov_trace_div8(uint64_t Val) {
  fprintf(f, "%p: div8(X, %lu)\n", __builtin_return_address(0), Val);
}
