...
COVERAGE_FLAGS="-fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div"
FUZZ_CXXFLAGS="-O2 -fno-omit-frame-pointer -g -fsanitize=address ${COVERAGE_FLAGS}"
