This is a benchmark for the Tiff Pef target in (RawSpeed)[https://github.com/darktable-org/rawspeed].

This is a benchmark for an (abort: out of range)[https://bugs.chromium.org/p/oss-fuzz/issues/detail?id=2831], and it takes a long time to find with libFuzzer.
